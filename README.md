...
* Because we choose the Gin HTTP framework, we can load all the templates in at initial time [See how to config it](https://github.com/gin-gonic/gin#html-rendering)
